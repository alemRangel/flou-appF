...
class LoadingView extends StatefulWidget {
  static const Key idleContentKey = ValueKey('idle');
...
class LoadingViewState extends State<LoadingView>
  ...
  bool get idleContentVisible => _idleController.value == 1.0;
  ...
  void didUpdateWidget(LoadingView oldWidget) {
    ...
    if (oldWidget.status != widget.status) {
      ...
      switch (oldWidget.status) {
        case LoadingStatus.idle:
          reverseAnimation = () => _idleController.reverse();
          break;
        case LoadingStatus.loading:
    ...
    return Stack(
      ...
      children: <Widget>[
        _TransitionAnimation(
          key: LoadingView.idleContentKey,
          controller: _idleController,
          child: widget.idleContent,
          isVisible: widget.status == LoadingStatus.idle,
        ),
        _TransitionAnimation(
